...
export declare class Swap {
     ...
     */
    initAccounts(params: InitSwapAccountParams): Promise<TransactionSignature>;
    /**
     ...
     */
    closeAccounts(params: CloseSwapAccountParams): Promise<TransactionSignature>;
    /**
